  ...
  useEffect(() => {
    ...
    setTasks(
      currentWorkspace?.projects?.reduce(
        (acc: any[], project: Project) => [...acc, ...project.tasks],
        []
      ) || []
    );
  }, [currentWorkspace]);
    ...
    <div className="space-y-6 max-w-6xl mx-auto">
      ...
      <div className="relative max-w-md">
        ...
        <input
          ...
          className="pl-8 w-full text-sm rounded-md border border-gray-300 dark:border-zinc-800 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-zinc-400 py-2 focus:outline-none focus:border-[#0b996f] transition"
        />
      </div>
          ...
          <div className="max-w-4xl w-full">
            ...
            {isMobile ? (
              <div className="space-y-3">
                {filteredUsers.map((user: WorkspaceMember) => (
                  <div
                    key={user.id}
              ...
              /* Desktop Table */
              <div className="sm:block overflow-x-auto rounded-md border border-gray-200 dark:border-zinc-800">
