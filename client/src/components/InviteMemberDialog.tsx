        ...
        <div className="mb-4">
          ...
          {currentWorkspace && (
            <p className="text-sm text-zinc-700 dark:text-zinc-400">
              ...
              <span className="text-[#0b996f] dark:text-[#0b996f]/90">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 mt-1 w-full rounded border border-zinc-300 dark:border-zinc-700 dark:bg-zinc-900 text-zinc-900 dark:text-zinc-200 text-sm placeholder-zinc-400 dark:placeholder-zinc-500 py-2 focus:outline-none focus:border-[#0b996f]"
                required
              />
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              className="w-full rounded border border-zinc-300 dark:border-zinc-700 dark:bg-zinc-900 text-zinc-900 dark:text-zinc-200 py-2 px-3 mt-1 focus:outline-none focus:border-[#0b996f] text-sm"
            >
