          ...
          {projects.length === 0 ? (
            <div className="p-12 text-center">
              ...
              <button
                ...
                className="mt-4 px-4 py-2 text-sm bg-gradient-to-br from-[#0b996f] to-[#0b996f]/90 text-white dark:text-zinc-200 rounded hover:opacity-90 transition"
              >
                ...
                >
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="w-full bg-zinc-200 dark:bg-zinc-800 rounded h-1.5">
                      <div
                        className="h-1.5 bg-[#0b996f] rounded"
