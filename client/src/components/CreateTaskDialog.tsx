        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              className="w-full rounded dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-700 px-3 py-2 text-zinc-900 dark:text-zinc-200 text-sm mt-1 focus:outline-none focus:ring-2 focus:ring-[#0b996f]"
              required
            />
          </div>
          ...
          <div className="space-y-1">
            ...
            <textarea
              ...
              className="w-full rounded dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-700 px-3 py-2 text-zinc-900 dark:text-zinc-200 text-sm mt-1 h-24 focus:outline-none focus:ring-2 focus:ring-[#0b996f]"
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1">
              ...
              >
                ...
                {teamMembers.map((member: { user: User }) => (
