    ...
    >
      ...
      <div className="flex items-start justify-between mb-3">
        <div className="flex-1 min-w-0">
          <h3 className="font-semibold text-gray-900 dark:text-zinc-200 mb-1 truncate group-hover:text-[#0b996f] dark:group-hover:text-[#0b996f]/90 transition-colors">
            {project.name}
          </h3>
      ...
      <div className="space-y-2">
        ...
        <div className="w-full bg-gray-200 dark:bg-zinc-800 h-1.5 rounded">
          <div
            className="h-1.5 rounded bg-[#0b996f]"
